...
// Max global fourier basis
#define VOLREND_GLOBAL_FC_MAX 120
...
struct RenderOptions {
    ...
    float dyn_speed = 1.;
    float fps = 30.;
    double stamp_previous = 0.;
    bool render_backwards = false;
    bool round_timestep = true;

    bool vary_timesteps = false;
};
